...
public class EntityPengu extends EntityCreature
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(3, new EntityAITempt(this, 1.3D, false, TEMPTATION_ITEMS));
    ...
    public boolean attackEntityAsMob(Entity entityIn)
    {
        ...
        boolean flag = entityIn.attackEntityFrom(DamageSource.causeMobDamage(this), (float)(0 + this.rand.nextInt(1)));
